...
import tree from './assets/images/cepage/tree.png';
...
<HamburgerMenu/>
   ...
   <div className='bg-cepage-header-bg  w-full h-screen bg-cover bg-center bg-no-repeat  ' >
      <div className=' container  mx-auto  d-flex relative'>
         ...
         >
         <img className='absolute w-6/12    -left-80  top-1/4  '  src={tree} /> 
         </Plx> 
         <Plx
         parallaxData={[
         {
         ...
         >
         <img className='absolute  w-4/12  h-auto end-36 '  src={cepageTitle} /> 
         </Plx>               
      </div>
   </div>
         ...
         <div className='container mx-auto p-5 text-center '>
            <div className="grid grid-cols-1 gap-8   md:grid-cols-2 ">
               ...
               <div className=' grid grid-cols-1 gap-4 place-items-right pt-24 relative '>
                  ...
                  >
                  <img className=' absolute w-full h-auto  md:w-11/12'  src={cabernetGrapes} />
                  </Plx>
               </div>
            </div>
         </div>
      ...
      <div className='container mx-auto  text-center '>
         <div className="grid grid-cols-1 md:grid-cols-2 ">
            ...
            <Plx
                  ...
                  >
               <img className='absolute w-full h-auto md:w-11/12'  src={merlotGrapes} />
               </Plx>
            </div>
   ...
   <div className='bg-ugni-blanc-bg  w-full h-screen  bg-cover bg-center bg-no-repeat  ' >
      <div className='container mx-auto p-5 text-center '>
         <div className="grid grid-cols-1 gap-8   md:grid-cols-2 ">
            <article class="text-wrap ">
               <div className=' grid grid-cols-1 gap-4  place-items-center  pt-36'>
                  <img className='w-96 h-auto '  src={ugniblancGrapes} />                                        
                  <p className=' font-Trojan 
                     mb-3
                     w-9/12                                   
                     text-sm
